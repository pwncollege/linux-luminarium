...
function hint_handler
{
	...
	[ -f *-TRAPPED ] && echo "BOOM! This hint has self-destructed becaused you entered this directory (using cd)! You will need to restart the challenge to continue." > *-TRAPPED
